...
def getConclu(path):
    ...
    for i in range(len(corpus)):
        ...
        if line[
            0] == 1 or "discussion" in line.lower() or "discussions" in line.lower() or "references" in line.lower() or "acknowledgements" in line.lower() or "acknowledgement" in line.lower():
            break
...
def getDiscu(path):
    ...
    for i in range(len(corpus)):
        ...
        if line[
            0] == 1 or "conclusions" in line.lower() or "conclusion" in line.lower() or "references" in line.lower() or "acknowledgements" in line.lower() or "acknowledgement" in line.lower():
            break
...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 1:
        ...
        if choix == "1":
            ...
            rep = input("Entrer le chemin du repertoir: ")
        ...
        if choix == "1" or choix == "2":
            ...
            for file in listFile:
                if ".pdf" in file:
                    print("En train de travailler sur le fichier " + file)
                    stdout = sys.stdout
                    if choix == "1":
                        pathFile = rep + "/" + file
                    elif choix == "2":
                    ...
                    if (str(sys.argv[1]) == "-x"):
                        ...
                        with open(pathXml, 'w') as sys.stdout:
                            ...
                            print("		<auteur>", getAuthors(pathFile), "</auteur>")
                            ...
                            print("		<biblio>", getBiblio(pathFile), "</biblio>")
                            print("</article>")
                    sys.stdout = stdout
